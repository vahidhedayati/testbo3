...
<html>
	...
	<body>
		<a href="#edit-os" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-os" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:osInstance, action:'update']" method="PUT" >
